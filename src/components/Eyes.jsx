...
function Eyes() {
  ...
  return (
    <div className="eyes w-full h-screen overflow-hidden">
      <div data-scroll data-scroll-section data-scroll-speed="-.7" className="relative w-full h-full bg-cover bg-center bg-yellow-300 bg-[url('./images/bg-yellow-eye-bubbles.png')]">
